...
4. From there on, reveal the next 10 to 30 characters of the correct query, so that the student sees a small part of the correct query.
...
`,
user: `
I need help with my SQL query. Please provide me with feedback on why my SQL statement might not be correct.
`
};
